...
/* O(1) - push element to vector, increase capacity if needed, return 0 on success*/
int DVectorPushBack(vector_t *vector, void *element);

/* O(1) - pop last element , decrease capacity if needed, return 0 on success */
...
/* O(1) - may increase capacity to held reserve, return 0 on success*/
