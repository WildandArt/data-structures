...
will insert into the list. Should return zero if "data" and "new_data" are equal then there order will be the "new_data" and then "data",
 positive if "new_data" should come before "data", and negative if after 				                                */
