...
typedef int (*sll_action_func_t) (void *data, void * param);
 
typedef int (*sll_compare_func_t) (void *data, void *param);
...
/* Complexity - time Complexity O(1), space complexity O(1).
   Returns 1 if equal and 0 if not. Function comparing if same iterator. */
...
sll_iter_t SLLFind(sll_iter_t from, sll_iter_t to, sll_compare_func_t cmp,\
 void *param);
...
int SLLForEach(sll_iter_t from, sll_iter_t to, sll_action_func_t action,\
 void *param);

/*****************************************************************************/
int SLLActionCounter(void* data, void* param);
